...
reviews_arr=[
    ...
    Review(rating=3, review_text='Decent place for a casual meal.', customer_id=6, eatery_id=5),
    ...
    Review(rating=4, review_text='Bru how do you spell restoraunt', customer_id=6, eatery_id=8),
    ...
    Review(rating=1, review_text='Good spot for a relaxed meal, if you like shit food', customer_id=6, eatery_id=20),
